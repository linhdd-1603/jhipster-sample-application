package vn.sun.mylog.repository;

import vn.sun.mylog.MyblogApp;
import vn.sun.mylog.config.Constants;
import vn.sun.mylog.config.audit.AuditEventConverter;
import vn.sun.mylog.domain.PersistentAuditEvent;
...
import static vn.sun.mylog.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
